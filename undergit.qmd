...
Let's create a private repo with an inner circle of collaborators.
...
# Step 1: Fetch remote changes (DO NOT PULL YET)
git fetch origin
# Step 2: Merge remote into local (explicit merge)
git merge origin/main
# This creates a proper merge commit
# Step 3: Resolve conflicts if any
# e.g.: git nano conflicted-files.txt
# Edit conflicted files...
# Important: Remove ALL conflict markers
# (<<<<<<<, =======, >>>>>>>)
git add resolved-file.txt
# Step 4: Complete the merge
git commit -m "Merge remote changes from origin/main"
# Step 5: Now push
git push origin main
...
There is always other options: create new branches, for example. And prevention helps as well:
