...
![](images/newrepo.png){width="100%"}<br><br> Nevertheless, I suggest you to add some features from the begining. Relevant features to take into account:
...
Let's add a bit of code:<br> <https://r4ds.had.co.nz/><br> <https://github.com/BrainMapINB><br>

-   Upload it through the repo's uploader. Limits: up to 100 files at once; files \< 25Mb. And don't forget the licence.
...
<center>![](images/mainbranch.png)<br> [Source: https://pdh11.blogspot.com/2013/09/a-git-workflow-at-ei.html]{style="font-size: 50%;"}</center>
